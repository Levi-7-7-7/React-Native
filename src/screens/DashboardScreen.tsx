...
export default function DashboardScreen() {
  ...
  const cappedTotal = useMemo(() => {
    if (!certificates.length || !categories.length) {
      return 0;
    }
  ...
  const getActivityStatusStyle = (status: string) => {
    switch (status?.toLowerCase()) {
      case 'approved':
        return {color: colors.badgeApprovedText};

      case 'pending':
        return {color: colors.badgePendingText};

      case 'rejected':
        return {color: colors.badgeRejectedText};
            ...
            <View style={styles.passBannerText}>
              <Text
                style={[
                  ...
                  {
                    color: colors.badgeApprovedText,
                  },
                ]}>
              ...
              <View
                ...
                <Text
                  style={[
                    ...
                    getActivityStatusStyle(cert.status),
                  ]}>
